...
import naveenAutomationAssignment.pages.WishListPage.MyWishList;
	...
	public class WishListTest extends TestBase {
		...
		public void verifyTitleOfPageItemSelectedwithPrice() {
			...
			Assert.assertEquals(laptopBookPage.successBannerOfAddedProductToWishList(),"Success: You have added MacBook Air to your wish list!\n×","ProductNotSuccessfully added");
            ...
            wishList.deleteLastProduct();
            Assert.assertEquals(wishList.successBannerAfterDeletingProductFromWishList(),"Success: You have modified your wish list!\n×", "Unsuccessful Modification" );
